...
abstract class AbstractIncrementalJava9JpsTest : AbstractIncrementalJpsTest() {
    override val enableExperimentalIncrementalCompilation: Boolean get() = true
    ...
    companion object {
        init {
            // See com.intellij.openapi.util.objectTree.ThrowableInterner. Will not be needed on 172
